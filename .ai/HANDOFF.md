...
- Node282/282(API 권한24/UI37 포함), JS/SW 문법·diff 검사 통과. 브라우저360/390/1440에서 사진 아래 긴 상품명/옵션명/참고가 및 미확인 안내, 일반 카드와 이미지 폭·이름/가격 글꼴 일치를 확인했다. 늦게 도착한 정확 SKU 가격도 UI.updateCardBadge 경로에서 가격 부분만 갱신하며 초점/열린 유료 팝업/10매장을 보존했다. 기존 유료 권한·취소/승인·키보드·근처/전국 정렬 검증 유지, 페이지 오류0. Main이 최신 무료360/390/1440 스크린샷을 직접 확인했다. 운영 배포 결과는 완료 후 기록한다.
