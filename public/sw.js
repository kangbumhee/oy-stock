const CACHE_NAME = 'olivestock-app-v20260913-stock-recovery-1';
const CORE_ASSETS = [
  '/',
  '/site.webmanifest',
  '/favicon.svg',
  ...
  '/terms.html',
  '/privacy.html',
  '/css/style.css?v=20260913-store-product-cards-1',
  '/js/config.js?v=20260913-stock-recovery-1',
  ...
  '/js/ui.js?v=20260913-stock-recovery-1',
  ...
  '/js/hidden-stock.js?v=20260913-store-product-cards-1',
  '/js/app.js?v=20260913-stock-recovery-1'
];
