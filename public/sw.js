const CACHE_NAME = 'olivestock-app-v20260820-search-completeness-1';
const CORE_ASSETS = [
  '/',
  '/site.webmanifest',
  '/favicon.svg',
  ...
  '/js/app.js?v=20260820-search-completeness-1'
];
